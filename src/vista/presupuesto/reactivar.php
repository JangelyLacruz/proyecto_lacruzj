    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="text-muted">El presupuesto volverá a estar vigente.</p>
                
                <input type="hidden" id="nro_presupuesto_reactivar" name="nro_presupuesto_reactivar" value="">
            </div>
            ...
            <div class="modal-footer justify-content-center border-top-0" style="background-color: #f5f7fa;">
                ...
                <a id="btnReactivarConfirmado" href="#" class="btn btn-lg btn-success px-4 shadow-sm">
