        ...
        fetch(`index.php?c=PresupuestoControlador&m=obtener&id=${presupuestoId}`)
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    const vigenciaElement = document.getElementById('ver_vigencia');
                    if (presupuesto.vigencia == 1) {
                        vigenciaElement.textContent = 'Vigente';
                        vigenciaElement.className = 'badge bg-success';
                    } else {
                        vigenciaElement.textContent = 'Anulado';
                        vigenciaElement.className = 'badge bg-danger';
                    }

                    const modal = new bootstrap.Modal(document.getElementById('verPresupuestoModal'));
                    modal.show();
                } else {
