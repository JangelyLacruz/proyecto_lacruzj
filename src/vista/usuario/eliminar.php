    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="text-muted mb-0">El usuario será eliminado permanentemente del sistema.</p>
                <p class="text-muted">Esta acción no puede revertirse.</p>
                
                <input type="hidden" id="cedula_eliminar" name="cedula">
            </div>
            ...
            <div class="modal-footer justify-content-center border-top-0" style="background-color: #f5f7fa;">
                ...
                <button id="btnEliminarConfirmado" class="btn btn-lg btn-primary px-4 shadow-sm">
