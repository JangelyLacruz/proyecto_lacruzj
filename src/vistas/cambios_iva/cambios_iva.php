          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control inputMonto" name="monto_cambio_iva" pattern="<?php echo regexPrecio ?>" minlength="<?php echo minRegexPrecio ?>" maxlength="<?php echo maxRegexPrecio ?>" placeholder="12.00">
              </div>
            </div>
          </div>
        </div>
