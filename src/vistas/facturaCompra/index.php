...
<?php require_once('src/vista/facturaCompra/crear.php'); ?>
<?php require_once('src/vista/facturaCompra/anular.php'); ?>
<?php require_once('src/vista/facturaCompra/reactivar.php'); ?>
