<div class="modal fade" id="confirmarEliminarModalIva" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="text-muted mb-0">El IVA será eliminado permanentemente del sistema.</p>
            ...
            <div class="modal-footer justify-content-center border-top-0" style="background-color: #f5f7fa;">
                ...
                <a id="btnEliminarConfirmadoIva" href="#" class="btn btn-lg btn-primary px-4 shadow-sm">
