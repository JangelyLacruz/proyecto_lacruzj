...
<input type="hidden" class="nombreVista" value="presentaciones">

<?php
$instruccionesLista = [
  'encabezado' => 'Gestionar Presentaciones',
  'tituloBtnReg' => 'Agregar Presentaciones',
];
    ...
    <div class="modal-content border-0">
      <div class="modal-header text-white" style="background: linear-gradient(135deg, #4e54c8, #8f94fb);">
        <h5 class="modal-title" id="registrarUsuarioModalLabel">
          <i class="fas fa-box-open me-2"></i> Agregar Nueva Presentación
        </h5>
      ...
      <form class="formularioAjax validar" method="POST" action="" novalidate>
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              <label class="form-label">Cantidad que contiene</label>
    ...
    <div class="modal-content border-0">
      <div class="modal-header text-white" style="background: linear-gradient(135deg, #4e54c8, #8f94fb);">
        <h5 class="modal-title">
          <i class="fas fa-edit me-2"></i> Editar Presentación
        </h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form class="formularioAjax validar" method="POST" action="" novalidate>
