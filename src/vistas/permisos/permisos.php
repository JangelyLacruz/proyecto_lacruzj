...
<?php
$instruccionesLista = [
  'encabezado' => 'Gestionar Permisos del Sistema',
  'tituloBtnReg' => 'Agregar Permiso',
];
    ...
    <div class="modal-content border-0">
      <div class="modal-header text-white" style="background: linear-gradient(135deg, #4e54c8, #8f94fb);">
        <h5 class="modal-title" id="registrarUsuarioModalLabel">
          <i class="fas fa-user-plus me-2"></i> Agregar Nuevo Permiso
        </h5>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              ...
              <input type="text" class="form-control noRepetir" name="nombre_permiso" pattern="<?php echo regexNombreObj ?>" minlength="<?php echo minRegexNombreObj ?>" maxlength="<?php echo maxRegexNombreObj ?>" required>
            </div>
          </div>
        </div>
      ...
      <form class="formularioAjax validar" method="POST" action="" novalidate>
        <div class="modal-body">
          <div class="row">
            ...
            <input type="hidden" name="id_permiso" class="formularioActualizar">
            <div class="col-md-12 mb-3">
              <label class="form-label">Nombre del Permiso</label>
              <input type="text" class="form-control formularioActualizar noRepetir" name="nombre_permiso" pattern="<?php echo regexNombreObj ?>" minlength="<?php echo minRegexNombreObj ?>" maxlength="<?php echo maxRegexNombreObj ?>" required>
            </div>
          </div>
        </div>
        <div class="modal-footer justify-content-center" style="background-color: #f8f9fa;">
